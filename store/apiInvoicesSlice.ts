  ...
  return [
    {
      ...
      payorType: 'BUSINESS',
      createdAtIsoDate: DateTime.now().minus({ days: 1 }).toISODate(),
      paidOnIsoDate: null,
    ...
    },
    {
      ...
      createdAtIsoDate: DateTime.now().minus({ days: 16 }).toISODate(),
    ...
    },
    {
      ...
      payorType: 'BUSINESS',
      status: PlatformInvoiceStatus.PAID,
      createdAtIsoDate: DateTime.now().minus({ days: 21 }).toISODate(),
    ...
    },
    {
      ...
      customerFirstName: faker.person.firstName(),
      customerLastName: faker.person.lastName(),
      createdAtIsoDate: DateTime.now().minus({ days: 22 }).toISODate(),
      paidOnIsoDate: null,
    ...
    },
    {
      ...
      billFromBusinessEmail: faker.internet.email(),
      status: PlatformInvoiceStatus.DUE,
      createdAtIsoDate: DateTime.now().minus({ days: 24 }).toISODate(),
    ...
    },
    {
      ...
      customerFirstName: faker.person.firstName(),
      customerLastName: faker.person.lastName(),
      createdAtIsoDate: DateTime.now().minus({ days: 27 }).toISODate(),
    ...
    },
    {
      ...
      billFromBusinessEmail: faker.internet.email(),
      status: PlatformInvoiceStatus.PAID,
      createdAtIsoDate: DateTime.now().minus({ days: 29 }).toISODate(),
    ...
    },
    {
      ...
      customerFirstName: faker.person.firstName(),
      customerLastName: faker.person.lastName(),
      createdAtIsoDate: DateTime.now().minus({ days: 31 }).toISODate(),
    ...
    },
    {
      ...
      billFromBusinessEmail: faker.internet.email(),
      status: PlatformInvoiceStatus.PAID,
      createdAtIsoDate: DateTime.now().minus({ days: 32 }).toISODate(),
    ...
    },
    {
      ...
      customerFirstName: faker.person.firstName(),
      customerLastName: faker.person.lastName(),
      createdAtIsoDate: DateTime.now().minus({ days: 33 }).toISODate(),
